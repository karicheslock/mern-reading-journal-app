...
function BookItem({book}) {
    ...
    console.log(`${window.location.href}/edit-book/${book._id}`)
    ...
    <div className='container flex flex-col bg-amber-50 mb-4 font-mono border rounded shadow-2xl shadow-gray-900 max-w-md'>
        ...
        <div className='flex justify-between items-center mx-2 mt-2'>
            <div className='flex items-center'>
                ...
                <FacebookShareButton quote="Check out what I read!" url={`${window.location.href}/edit-book/${book._id}`} className='mr-2'>
                    <FacebookIcon round="true" size={36} />
                </FacebookShareButton>
                <TwitterShareButton quote="Check out what I read!" url={`${window.location.href}/edit-book/${book._id}`}>
